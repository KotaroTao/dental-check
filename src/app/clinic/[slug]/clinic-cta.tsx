...
export function ClinicCTA({ ctaConfig, mainColor, clinicId }: ClinicCTAProps) {
  ...
  const hasPrimaryCTA = ctaConfig.phone || ctaConfig.bookingUrl || ctaConfig.lineUrl;
  const hasSNS = ctaConfig.instagramUrl || ctaConfig.youtubeUrl || ctaConfig.facebookUrl || ctaConfig.tiktokUrl || ctaConfig.threadsUrl;

  if (!hasPrimaryCTA && !hasSNS) {
    return null;
  }
          ...
          <div className="grid grid-cols-2 gap-3 pt-2">
            {ctaConfig.youtubeUrl && (
              <a
                ...
                className="flex items-center justify-center gap-2 py-3 rounded-lg border-2 font-medium text-sm"
